...
export class EmployeeLeaveComponent implements OnInit {
  ...
  fileName= 'LeaveDetail.xlsx';

  Leavelist: any;
  Leavelistresult: any;

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['ABSENCEDAYS', 'ABSENCEHOURS', 'NAMEOFABSENCETYPE','VALIDBEGIN','VALIDEND'];
  ...
  ngOnInit(): void {
    ...
    this.employeeService.getLeave().subscribe((data) => {
      ...
      this.dataSource = new MatTableDataSource(this.Leavelistresult);
