...
export class DebitComponent implements OnInit {
  ...
  fileName= 'Customer_Debit.xlsx';

  Debitlist : any;
  Debitlistresults: any;

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['ALLOC_NMBR', 'COMP_CODE', 'BLINE_DATE', 'AMOUNT','TAX_CODE','CURRENCY'];
  ...
  ngOnInit() {
    ...
    this.customerService.getDebit().subscribe((data) => {
      ...
      this.Debitlistresults = this.Debitlist['SOAP:Envelope']['SOAP:Body'][0]['ns0:ZBAPI_FI_DEBIT_MEMO_AM.Response'][0]['IT_CREDIT_RESULT'][0]['item']
