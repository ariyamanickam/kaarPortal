...
export class DeliveryComponent implements OnInit {
  ...
  fileName= 'Customer_Delivery.xlsx';

  Deliverylist: any;
  Deliverylistresults: any;

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['VBELN', 'VKORG', 'LFDAT', 'LFUHR', 'WAERK'];

  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatPaginator) paginator: MatPaginator;

  constructor(private customerService: CustomerService, private _liveAnnouncer: LiveAnnouncer,private dialog: MatDialog
  ...
  ngOnInit() {
    ...
    this.customerService.getDeliverylist().subscribe((data) => {
      ...
      this.Deliverylistresults = this.Deliverylist['SOAP:Envelope']['SOAP:Body'][0]['ns0:ZBAPI_SD_DELIVERY_LIST_AM.Response'][0]['RESULT_DELIVERY_HEADER'][0]['item']
  ...
  fragment(data: any) {
    ...
    this.customerService.SetDeliveryDetail(data)
    
    this.dialog.open(DeliveryDetailComponent,{
