...
export class InvoiceComponent implements OnInit {
  ...
  fileName= 'Customer_Invoice.xlsx';

  Invoicelist: any;
  Invoicelistresult: any;

 

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['VBELN', 'VKORG', 'ERDAT', 'KNUMV', 'NETWR', 'WAERK'];
  ...
  ngOnInit(): void {
    ...
    this.customerService.getInvoicelist().subscribe((data) => {
      ...
      this.Invoicelistresult = this.Invoicelist['SOAP:Envelope']['SOAP:Body'][0]['ns0:ZBAPI_SD_INVOICE_LIST_AM.Response'][0]['IT_INVOICE_LIST'][0]['item']
      console.log("Invoice", this.Invoicelistresult);


      this.dataSource = new MatTableDataSource(this.Invoicelistresult);
  ...
  fragment(data: any) {
    ...
    this.customerService.PostInvoiceDetail(newInvoice).subscribe((data) => {
      console.log(data);
    ...
    // this.router.navigate(['/customerboard/InvoiceDetail']);
  }
