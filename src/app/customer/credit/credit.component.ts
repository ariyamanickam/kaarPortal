...
export class CreditComponent implements OnInit {
  ...
  fileName= 'Customer_credit.xlsx';
  Creditlist : any;
  Creditlistresults : any;

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['DOC_NO', 'COMP_CODE', 'DOC_DATE', 'AMOUNT', 'TAX_CODE','CURRENCY'];
  ...
  ngOnInit(){
    ...
    this.customerService.getCredit().subscribe((data) => {
      ...
      this.Creditlistresults = this.Creditlist['SOAP:Envelope']['SOAP:Body'][0]['ns0:ZBAPI_FI_CREDIT_MEMO_AM.Response'][0]['IT_CREDIT_RESULT'][0]['item']
