...
export class SalesComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['SD_DOC', 'SHIP_POINT','CREATION_DATE', 'MATERIAL','REQ_QTY', 'NET_PRICE','NET_VALUE'];
  ...
  ngOnInit() {
    ...
    this.customerService.getSaleslist().subscribe((data) => {
      ...
      this.Saleslistresults = this.Saleslist[0]['SALES_ORDERS'][0]['item']
      console.log("Saleslist", this.Saleslistresults);

      this.dataSource = new MatTableDataSource(this.Saleslistresults);
  ...
  fragment(data: any) {
    ...
    this.customerService.PostSalesDetail(newSales).subscribe((data) => {
      console.log(data);
      

    }, (err) => console.log(err));
    this.dialog.open(SalesDetailComponent,{
