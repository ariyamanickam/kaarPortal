...
export class VendorCreditComponent implements OnInit {
  ...
  fileName= 'Vendor_credit.xlsx';

  creditlist : any;
  creditlistresults: any;

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['DOC_NO', 'COMP_CODE', 'ITEM_NUM', 'LC_AMOUNT','LOC_CURRCY','FIS_PERIOD','FISC_YEAR'];
  ...
  ngOnInit(): void {
    ...
    this.vendorService.getCredit().subscribe((data) => {
      ...
      this.creditlistresults = this.creditlist['SOAP:Envelope']['SOAP:Body'][0]['ns0:ZBAPI_FI_VENDOR_CREDIT_AM.Response'][0]['ET_LINEITEM'][0]['item']
      console.log("Credit",this.creditlistresults);
      this.dataSource = new MatTableDataSource(this.creditlistresults);
