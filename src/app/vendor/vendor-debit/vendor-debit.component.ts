...
@Component({
  ...
  styleUrls: ['./vendor-debit.component.scss']
})
export class VendorDebitComponent implements OnInit {
  ...
  fileName= 'Vendor_Debit.xlsx';

  debitlist : any;
  debitlistresults: any;

  public dataSource: MatTableDataSource<any>;
  public displayedColumns: string[] = ['DOC_NO', 'AMOUNT', 'BLINE_DATE', 'DOC_TYPE','REF_DOC_NO','FISC_YEAR','FIS_PERIOD'];
  ...
  ngOnInit(): void {
    ...
    this.vendorService.getDebit().subscribe((data) => {
      ...
      this.debitlistresults = this.debitlist['SOAP:Envelope']['SOAP:Body'][0]['ns0:ZBAPI_FI_VENDOR_DEBIT_AM.Response'][0]['ET_LINEITEM'][0]['item']
      console.log("Dedit",this.debitlistresults);
      this.dataSource = new MatTableDataSource(this.debitlistresults);
